  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="searchMap" class="demo-form-inline">
      <el-form-item label="活动名称">
        <el-input v-model="searchMap.name" placeholder="填入活动名称查询" />
      </el-form-item>
      <el-form-item label="活动日期">
        <el-date-picker v-model="searchMap.starttime" type="date" placeholder="选择开始日期" />
        <el-date-picker v-model="searchMap.endtime" type="date" placeholder="选择结束日期" />
      </el-form-item>
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" @click="feachData">搜索</el-button>
        <el-button type="success" icon="el-icon-plus" @click="dialogVisible = true;pojo={};id=''">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-dialog title="活动信息编辑" :visible.sync="dialogVisible" width="70%">
      <el-form label-width="80px">
        ...
        <el-form-item label="基本地址">
          <el-input v-model="pojo.address" placeholder="基本地址" />
        </el-form-item>
        <el-form-item label="开始日期">
          <el-date-picker v-model="pojo.starttime" type="date" placeholder="开始日期" />
        </el-form-item>
        <el-form-item label="截至日期">
          <el-date-picker v-model="pojo.endtime" type="date" placeholder="截至日期" />
        </el-form-item>
        <el-form-item label="报名截止">
          <el-date-picker v-model="pojo.enrolltime" type="date" placeholder="报名截止" />
        </el-form-item>
        <el-form-item label="活动详情">
          <el-input v-model="pojo.detail" placeholder="活动详情" type="textarea" :rows="4" />
        </el-form-item>
        ...
        <el-form-item label="是否可见">
          <el-switch v-model="pojo.state" active-value="1" inactive-value="0" />
        </el-form-item>
        <el-form-item>
